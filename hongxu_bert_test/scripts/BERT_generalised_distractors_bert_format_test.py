...
"""
This script uses BERT's training format, `[CLS] context [SEP] question + choice [SEP]`  - Hongxu Zhou
"""
...
class MultipleChoiceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # FORMAT CHANGE: This maches how BertForMultipleChoice expects inputs
        pairs = []
        for choice in shuffled_choices:
            # Each pair is [context, question + choice]
            pairs.append([context, question + " " + choice])
...
def main():
    ...
    # 6. Save results
    output_file = '/scratch/s5788668/bert_generated_distractor_bert_format_results.csv'

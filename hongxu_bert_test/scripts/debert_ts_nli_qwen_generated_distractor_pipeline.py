"""
This script uses the model sileod/deberta-v3-large-tasksource-nli with first 1500 entries from qwen generated distractors. 
...
def main():
    ...
    dataset_path = '/scratch/s5788668/qwen_distractors.csv' # New Qwen data
    ...
    for result in results:
        ...
        options_str = ','.join([str(choice) for choice in result['shuffled_choices']]) # convert all digits distractors to str
    ...
    output_file = '/scratch/s5788668/deberta_nli_qwen_generated_distractors_results.csv'

...
"""
This script uses BERT's training format but with the `context` removed to investigate how it affects model's performance  - Hongxu Zhou
"""
...
class MultipleChoiceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # KEY CHANGE: the context is kept empty on purpose
        pairs = []
...
def main():
    ...
    # 6. Save results
    output_file = '/scratch/s5788668/bert_generated_distractor_bert_format_no_context_results.csv'
